pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.233.109.64:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Ganesh30112006/cicdexp3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.233.109.64:9090/springapp1"
            echo "✅ Frontend deployed: http://13.233.109.64:9090/frontapp1"
        }
        failure {
